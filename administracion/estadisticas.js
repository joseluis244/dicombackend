...
module.exports.Dashboard = async function (){
    ...
    respuesta.EstudiosModalidadDia = await EstudiosModalidad(moment().subtract(1, 'days').startOf('month').format("YYYYMMDD"),moment().format("YYYYMMDD"));
    respuesta.EstudiosMaquinasDia = await EstudiosMaquinas(moment().subtract(1, 'days').startOf('month').format("YYYYMMDD"),moment().format("YYYYMMDD"));
